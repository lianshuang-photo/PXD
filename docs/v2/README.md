...
更新：2026-09-20。状态：**首批模块已组装，PR #51 为草稿；真机验收部分通过，尚不具备合并条件。** 见[实施状态](IMPLEMENTATION-STATUS.md)与[协作规则](COLLABORATION.md)。
...
- [实施 PR #51](https://github.com/lianshuang-photo/PXD/pull/51) 包含规划文档与应用。规划 PR #50 保留历史记录；Alpha 固定在 `ls-studio-v2-alpha.0`。`V2` 是产品代际，未把包版本改成 2.0.0。
